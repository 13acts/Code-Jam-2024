...
class Gemini:
    ...
    ----------
    model
        Represents the underlying Generative AI model.
    safety_settings : dict
        Safety configs defined as `HarmCategory`, `HarmBlockThreshold` pairings.
    finish_errors : dict
    ...
    async def generate_conversation(self, prompt: str) -> str:
        ...
        ----------
        prompt : str
            A humane description of the conversation topic.
    ...
    async def verify(self, response: generation_types.AsyncGenerateContentResponse) -> str:
        ...
        ----------
        response
            An `AsyncGenerateContentResponse` instance for managing the response
            generated by an internal call to `genai.GenerativeModel.generate_content_async`.

        Returns
        -------
        str
            A JSON string of the form {"summary": _errmsg_or_data_}
